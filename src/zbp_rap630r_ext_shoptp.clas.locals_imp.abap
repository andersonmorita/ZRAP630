...
CLASS lhc_shop IMPLEMENTATION.
  ...
  METHOD zz_validateDeliverydate.
    READ ENTITIES OF ZRAP630i_ShopTP_05A IN LOCAL MODE
            ENTITY Shop
...
DATA update_bo      TYPE TABLE FOR UPDATE     ZRAP630i_ShopTP_05A\\Shop.
 DATA update_bo_line TYPE STRUCTURE FOR UPDATE ZRAP630i_ShopTP_05A\\Shop .
 ...
 DATA(product_value_help) = NEW zrap630_cl_vh_product_05A(  ).
 ...
 MODIFY ENTITIES OF zrap630i_shoptp_05A IN LOCAL MODE
   ENTITY Shop
     UPDATE FIELDS (
     OverallStatus
     CurrencyCode
